...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 bg-gradient-to-br from-[#2a1a1a] to-[#1a1212]">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {steps.map((step) => (
            <div key={step.number} className="text-center">
              {/* Icon */}
              <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-orange-900/30 border-2 border-orange-600 text-orange-500 mb-6">
                {step.icon}
              </div>
