...
export default function Sidebar({ user, credits }: { user: User; credits: number }) {
  ...
  return (
    <>
      ...
      <aside
        className={`lg:relative lg:translate-x-0 fixed top-0 left-0 h-full w-64 bg-[#161a25] border-r border-slate-700/50 p-4 pt-8 lg:pt-8 z-30 lg:z-0 transition-transform duration-300 flex flex-col justify-between text-slate-200 ${
