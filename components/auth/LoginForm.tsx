  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="text-sm text-slate-400 underline decoration-dotted underline-offset-4 hover:text-blue-400 transition-colors"
          >
            {t.forgotPassword}
          </Link>
        </div>
      ...
      <p className="text-center text-slate-400 text-sm">
        {t.noAccount}{' '}
        <Link href={`/${locale}/auth/signup`} className="text-blue-500 hover:text-blue-400 font-medium underline">
          {t.signupLink}
        </Link>
      </p>
    </div>
